package com.gmail.artemis.the.gr8.tutorialplugin.filehandlers;

import com.gmail.artemis.the.gr8.tutorialplugin.Main;
...
public class TestFileHandler {
    ...
    private ConfigurationSection playerCount;
    ...
    public void saveTimeTaken(long time, String timeDescription) {
        try {
    ...
    private void saveToSection(long time, ConfigurationSection section) {
